 ...
 *
 * @link [API Docs](https://tanstack.com/router/latest/docs/api/router/MatchRouteOptionsType#matchrouteoptions-type)
 */
export interface MatchRouteOptions {
  /**
   * If `true`, will match against pending location instead of the current location.
   *
   * @link [API Docs](https://tanstack.com/router/latest/docs/api/router/MatchRouteOptionsType#pending-property)
   */
  pending?: boolean
  /**
   * If `true`, will match against the current location with case sensitivity.
   *
   * @link [API Docs](https://tanstack.com/router/latest/docs/api/router/MatchRouteOptionsType#casesensitive-property)
   *
   ...
   *
   * @link [API Docs](https://tanstack.com/router/latest/docs/api/router/MatchRouteOptionsType#includesearch-property)
   */
  includeSearch?: boolean
  /**
   * If `true`, will match against the current location using a fuzzy match. e.g. `/posts` will match for a current location of `/posts/123`.
   *
   * @link [API Docs](https://tanstack.com/router/latest/docs/api/router/MatchRouteOptionsType#fuzzy-property)
   */
  fuzzy?: boolean
}
